            ...
            <div class="card ">
                <div class="card-body">
                    <form class="form-horizontal"
                        action="{{ $model->exists ? route('administrator.about.update', base64_encode($model->id)) : route('administrator.about.store') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea name="short_description" placeholder="Deskripsi Singkat"
                                    class="form-control @error('short_description') is-invalid @enderror" rows="5">{{ $model->exists ? $model->short_description : old('short_description') }}</textarea>
