    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                cache: false,
                ajax: {
                    url: "{{ route('administrator.category.datatable') }}",
                    type: 'POST',
                    headers: {
            ...
            const toolbar = '<div class="dt-buttons btn-group flex-wrap">' +
                '<a href="{{ route('administrator.category.create') }}" class="btn btn-sm bg-inventory" title="Tambahkan Category Baru"><i class="fas fa-plus"></i> Tambahkan Category Baru</a>' +
                '</div>';
