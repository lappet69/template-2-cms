...
@section('content-header')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="nav-icon fas fa-boxes"></i> Area Praktek</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active"><i class="nav-icon fas fa-boxes"></i> Area Praktek</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                cache: false,
                ajax: {
                    url: "{{ route('administrator.area-praktek.datatable') }}",
                    type: 'POST',
                    headers: {
            ...
            const toolbar = '<div class="dt-buttons btn-group flex-wrap">' +
                '<a href="{{ route('administrator.area-praktek.create') }}" class="btn btn-sm bg-inventory" title="Tambahkan Area Praktek"><i class="fas fa-plus"></i> Tambahkan Area Praktek</a>' +
                '</div>';
