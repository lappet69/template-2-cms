        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">
                        @if ($model->exists)
                            <i class="nav-icon fas fa-eidt"></i> Edit Area Praktek
                        @else
                            <i class="nav-icon fas fa-plus"></i> Tambah Area Praktek
                        @endif
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><i class="nav-icon fas fa-boxes"></i> Area Praktek</li>
                        @if ($model->exists)
                            <li class="breadcrumb-item active"><i class="nav-icon fas fa-edit"></i> Edit Area Praktek
                                Phincon</li>
                        @else
                            <li class="breadcrumb-item active"><i class="nav-icon fas fa-plus"></i> Tambah Area Praktek
                            </li>
                        @endif
                    </ol>
                </div><!-- /.col -->
            ...
            <div class="card ">
                <div class="card-body">
                    <form class="form-horizontal"
                        action="{{ $model->exists ? route('administrator.area-praktek.update', base64_encode($model->id)) : route('administrator.area-praktek.store') }}"
                        ...
                        <div class="form-group row">
                            <label for="gambar" class="col-sm-2 col-form-label">Icon / Gambar Area Praktek</label>
                            <div class="col-sm-10">
