...
@section('content-header')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="nav-icon fas fa-boxes"></i> Lawyer</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active"><i class="nav-icon fas fa-boxes"></i> Lawyer</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                cache: false,
                ajax: {
                    url: "{{ route('administrator.lawyer.datatable') }}",
                    type: 'POST',
                    headers: {
            ...
            const toolbar = '<div class="dt-buttons btn-group flex-wrap">' +
                '<a href="{{ route('administrator.lawyer.create') }}" class="btn btn-sm bg-inventory" title="Tambahkan Lawyer"><i class="fas fa-plus"></i> Tambahkan Lawyer</a>' +
                '</div>';
